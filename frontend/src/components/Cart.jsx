        ...
        return (
            ...
            { books.map( book => {
               if(book.inCart === true){
                ...
                document.querySelector('.total-cart').style = "border: none";
                totalCheckout += book.price * book.total
                   return(   
                        <div key={book.id} className="row cart-item">
                           ...
                           <div className="row">
                            <div className="col-6">
                            Q:<select name="quantity" value={book.total} onChange={(e) => handleChangeQ(e, book.id)}>
                           ...
                           <div className="col-3">
                            <p className="close-btn" onClick={(e) => handleRemoveItemFromCart(e, book.id)}>X</p>
                           </div>
                        </div>
                        </div>
                           </div>
            ...
            <h4 className="total-cart">Total:${totalCheckout}</h4>
            </div>
